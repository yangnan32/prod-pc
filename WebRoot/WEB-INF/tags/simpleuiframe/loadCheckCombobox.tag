...
%>
<div id="select_checkbox<%=id%><%=uuid%>" class="uiframe-mainCon" data-loadflag="true" data-id="${id}" data-url="<%=url%>" data-dataroot="<%=dataRoot%>" data-xtype="checkbox" data-key="<%=key%>" data-val="<%=val%>" data-height="<%=H%>" hotKeyFlag="<%=hotKeyFlag%>" data-useToolPage="<%=toolbar%>">
